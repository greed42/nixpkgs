...
let
  ...
  src = fetchFromGitHub {
    ...
    hash =
      {
        "0.135.0" = "sha256-N163rC8kErZresODLV8bNOp/lZR+I/s9ddC/nZrzH5c=";
...
lib.recurseIntoAttrs {
  otelcol = mkDistribution {
    ...
    sourceHash =
      {
        "0.135.0" = "sha256-OXcBpnHOLuIP6kR676NMIkqaP+kQXsvacFFKrsnTMAQ=";
        "0.142.0" = "sha256-yJt77K49C1ciu5ab2O4czK/rtjmxhI5JOXJw8N0141w=";
      }
      .${version} or lib.fakeHash;
    vendorHash =
      {
        "0.135.0" = "sha256-sK/H9VxL7kCrROqr5zJUcn7NfPh7ZpsJ/0TQeEWKnm8=";
  ...
  otelcol-contrib = mkDistribution {
    ...
    sourceHash =
      {
        "0.135.0" = "sha256-tkuWU1Wx5lQey57euRww4QHsL16oayYWw395sVujbdA=";
        "0.142.0" = "sha256-J9zWL4N1eAn4H6/TQ+WY9gVBokb2k2NiqIk08X5zIw4=";
      }
      .${version} or lib.fakeHash;
    vendorHash =
      {
        "0.135.0" = "sha256-bsDOxrupB4XzVhGU7zbHHeEG5lxHBqWij6pcfjsgP7Y=";
  ...
  otelcol-k8s = mkDistribution {
    ...
    sourceHash =
      {
        "0.135.0" = "sha256-kO5xLaw7/eXimkPbxSqr/csh/omUlsrKG/5O27VlY5c=";
        "0.142.0" = "sha256-UZBAoX6h5hFQQuop68nlQAer/zqtUxO2mSlOYkKYses=";
      }
      .${version} or lib.fakeHash;
    vendorHash =
      {
        "0.135.0" = "sha256-h0IA7iaS+LOkYJAsghwOtUeEL6GWNtpGc6xDKT21Q9I=";
  ...
  otelcol-otlp = mkDistribution {
    ...
    sourceHash =
      {
        "0.135.0" = "sha256-d2R3DWh13gXtzm0mBMfnMUV+t8qVLiccQQ/W3yGyd4Q=";
        "0.142.0" = "sha256-5rYrAPGvS+zSkW/1uDCYGSeDkr1JG6z8h34gvS5uW9Y=";
      }
      .${version} or lib.fakeHash;
    vendorHash =
      {
        "0.135.0" = "sha256-zTThbJFoqZ4hecQ5DBwdnjEngU8N/V9YfVjxt2LW8PM=";
